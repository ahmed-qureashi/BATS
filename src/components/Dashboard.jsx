              ...
              <div className="flex flex-col sm:flex-row items-start gap-3">
                ...
                <div className="flex-1">
                  <p className="text-gray-300 text-sm sm:text-base leading-relaxed">
                    BATS supports <strong className="text-white">8 major EVM-compatible networks</strong> including <span className='text-purple-400'>Polygon, Base, Ethereum Sepolia, BNB Smart Chain, ZetaChain, Somnia, Avalanche, and Arbitrum.</span>
