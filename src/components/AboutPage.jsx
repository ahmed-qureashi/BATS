          ...
          <div className="container mx-auto px-4">
            <div className="text-center max-w-5xl mx-auto">
              ...
              <p className="text-sm md:text-lg text-gray-300 mb-6 leading-relaxed max-w-4xl mx-auto">
                BATS revolutionizes cryptocurrency access with advanced multi-wallet technology, currently supporting
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="text-sm md:text-lg text-gray-300 mb-6 leading-relaxed">
                ...
                and burner accounts for anonymity. BATS brings this revolutionary concept to cryptocurrency with
              ...
              <p className="text-sm md:text-lg text-gray-300 mb-6 leading-relaxed">
                ...
                transactions, someone who needs secure escrow agreements, or instant blockchain access, BATS provides the perfect solution.
              </p>
          ...
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-sm md:text-lg text-gray-300 mb-8 leading-relaxed">
                ...
                needs quick blockchain access, BATS provides the perfect solution for every scenario.
              </p>
        ...
        <div className="relative z-10 container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-sm md:text-lg text-gray-300 mb-8 leading-relaxed">
                Security isn't an afterthought - it's the foundation of everything we build. BATS employs
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-sm md:text-lg text-gray-300 mb-8 leading-relaxed">
                BATS is built on a foundation of modern web technologies and industry-standard blockchain libraries.
      ...
      <section className="relative py-20 bg-neutral-950">
        ...
        <div className="relative z-10 container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-sm md:text-lg text-gray-300 mb-6 leading-relaxed">
              BATS is completely open source and transparent. Every line of code is auditable,
...
{/* 
            <div className="flex flex-wrap justify-center gap-6">
              <a
                href="https://github.com/chetanck03/SominaBATS" target="_blank"
