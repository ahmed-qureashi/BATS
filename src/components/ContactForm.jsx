 ...
 *    - {{to_name}} - Recipient name (SominaBATS Team)
...
function ContactForm({ isFullPage = false }) {
  ...
  const faqs = [
    {
      question: "Is BATS safe to use?",
      answer: "Yes, BATS is built with security as the top priority. Your private keys are stored locally and encrypted, never transmitted to our servers."
    },
    {
      question: "Which blockchains are supported?",
      answer: "Currently, BATS supports Ethereum and Solana networks. We're working on adding support for more blockchains."
    },
    {
      question: "Is BATS open source?",
      answer: "Yes, BATS is completely open source. You can view and contribute to the code on our GitHub repository."
    },
    {
          ...
          <div className="relative z-10 container mx-auto px-4">
            <div className="text-center max-w-4xl mx-auto">
              ...
              <p className="text-xl md:text-2xl text-gray-300 mb-8 leading-relaxed">
                ...
                Our team is here to assist you with anything related to BATS.
              </p>
            </div>
          </div>
        </section>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 max-w-6xl mx-auto">
              ...
              <div>
                ...
                <p className="text-lg text-gray-400 mb-8">
                  We're always excited to hear from our community and help you make the most of BATS.
                </p>
