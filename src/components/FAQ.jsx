...
function FAQ() {
  ...
  const faqs = [
    ...
    {
      question: "How secure is BATS and where are my private keys stored?",
      answer: "BATS employs enterprise-grade security with complete client-side cryptographic operations. Your private keys never leave your browser and are stored locally with encryption. We use industry-standard BIP-39/BIP-44 compliance, Web Crypto API for secure random generation, and maintain a zero data collection policy. All cryptographic operations happen locally using ethers.js and secure smart contract interactions."
    },
    {
      question: "Can I import existing wallets from MetaMask, Trust Wallet, or other wallets?",
      answer: "Yes! BATS supports importing existing wallets using 12 or 24-word mnemonic phrases with full BIP-39 validation and cross-platform compatibility. Since we use standard derivation paths, wallets imported from MetaMask, Trust Wallet, Coinbase Wallet, and other standard wallets work seamlessly. Your existing wallet addresses will be identical due to our BIP-44 compliance."
    },
    {
      question: "Is BATS completely free to use?",
      answer: "Yes, BATS is completely free and open source. There are no subscription fees, hidden costs, or premium features. You only pay standard blockchain network fees (gas fees) when making transactions or using escrow services. All features including multi-chain support, QR code functionality, escrow system, faucet access, and AI assistance are available at no cost."
    },
    {
      question: "How does BATS ensure compatibility with existing DeFi and Web3 applications?",
      answer: "BATS uses industry-standard cryptographic methods: BIP-39 for mnemonic generation, BIP-44 for hierarchical derivation, EIP-155 for chain IDs, and EIP-1559 for gas fees. This ensures full compatibility with all major wallet providers and Web3 applications. BATS-generated wallets work seamlessly with DeFi protocols, NFT marketplaces, and dApps across all 8 supported networks, with the integrated escrow system enabling secure DeFi interactions."
    }
  ]
      ...
      <div className="relative z-10 container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-gray-300 max-w-2xl mx-auto leading-relaxed">
            Get quick answers to common questions about BATS
          </p>
        </div>
