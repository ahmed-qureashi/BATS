/**
 * AWS SNS Integration for BATS Email Notifications
...
const sendFallbackEmail = async (escrowData) => {
  try {
    ...
    const fields = {
      ...
      name: 'BATS Team',     // This matches {{name}} in your EmailJS template
      message: `🎉 BATS Escrow Created Successfully!
...
Your funds are now securely held in the BATS smart contract. The recipient can claim them, or you can refund if unclaimed.

📱 Track Your Escrow:
Visit https://BATS.software to monitor your escrow status.

Thank you for using BATS! 🚀

---
BATS Team
https://BATS.software`,
      reply_to: 'noreply@BATS.software'
    }
...
Visit https://BATS.software to manage your escrow.
...
const sendAlternativeEmail = async (escrowData) => {
  try {
    ...
    formData.append('subject', `🎉 BATS Escrow Created - ${escrowData.amount} ${escrowData.symbol}`)
    formData.append('message', `
🎉 BATS Escrow Created Successfully!
...
const tryAWSSESEmail = async (escrowData) => {
  try {
    ...
    const emailSubject = `🔐 BATS Escrow Created Successfully - ${escrowData.amount} ${escrowData.symbol}`
    
    const emailBody = `
🎉 Your BATS Escrow has been created successfully!
...
📱 Track Your Escrow:
Visit https://BATS.software to monitor your escrow status and manage your transactions.

Thank you for using BATS - The Future of Multi-Chain Escrow! 🚀
...
https://BATS.software
    ...
    const fromName = import.meta.env.VITE_AWS_SES_FROM_NAME || 'BATS Team'
            ...
            Data: `
              <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; background-color: #f9f9f9;">
                <div style="background-color: #1a1a1a; color: white; padding: 30px; border-radius: 10px;">
                  <h1 style="color: #8b5cf6; margin-bottom: 20px;">🎉 BATS Escrow Created Successfully!</h1>
                  ...
                  <div style="background-color: #2a2a2a; padding: 20px; border-radius: 8px; margin: 20px 0;">
                    ...
                    <p>Your funds are now securely held in the BATS smart contract. The recipient can claim them, or you can refund if unclaimed.</p>
                  </div>
                  
                  <div style="text-align: center; margin: 30px 0;">
                    <a href="https://BATS.software" style="color: #8b5cf6; text-decoration: none;">
                      📱 Visit BATS to manage your escrow
                    </a>
                  </div>
                  
                  <hr style="border: 1px solid #444; margin: 30px 0;">
                  <p style="text-align: center; color: #888; font-size: 14px;">
                    Thank you for using BATS - The Future of Multi-Chain Escrow! 🚀<br>
                    <a href="https://BATS.software" style="color: #8b5cf6;">BATS.software</a>
                  </p>
                </div>
              </div>
            `,
