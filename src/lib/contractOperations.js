...
import { getBATSContract, EscrowStatus, validateContractConnectivity } from './contractConfig'
...
export const createEscrow = async (blockchain, network, privateKey, receiver, amount, gasLimit = '300000') => {
    try {
        ...
        if (!isContractAccessible) {
            throw new Error("Cannot connect to BATS contract. Please check your network connection.")
        }
        ...
        const contract = getBATSContract(blockchain, network, privateKey)
